...
_load(CVal.path + '/resources/static/js/common/logm/Base.js?require=http://21.32.3.70:8200/bho/logm.js,' + CVal.path + '/resources/static/js/bho/main.js&app=bho&_=' + (new Date()).getTime());